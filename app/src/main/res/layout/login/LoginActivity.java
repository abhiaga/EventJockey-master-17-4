...
public class LoginActivity extends Activity
{
    ...
    Backendless.UserService.isValidLogin( new DefaultCallback<Boolean>( this )
    {
      ...
      public void handleResponse( Boolean isValidLogin )
      {
        if( isValidLogin && Backendless.UserService.CurrentUser() == null )
        {
          ...
          {
            Backendless.UserService.findById( currentUserId, new DefaultCallback<BackendlessUser>( com.examples.eventjockey.login.LoginActivity.this, "Logging in..." )
            {
              @Override
  ...
  public void onLoginButtonClicked()
  {
    ...
    Backendless.UserService.login( identity, password, new DefaultCallback<BackendlessUser>( com.examples.eventjockey.login.LoginActivity.this )
    {
      public void handleResponse( BackendlessUser backendlessUser )
      {
        super.handleResponse( backendlessUser );
        startActivity( new Intent( com.examples.eventjockey.login.LoginActivity.this, LoginSuccessActivity.class ) );
        finish();
      }
    }, rememberLogin );
  }
