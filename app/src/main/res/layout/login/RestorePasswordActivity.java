  ...
  public void onRestorePasswordButtonClicked()
  {
    ...
    Backendless.UserService.restorePassword( login, new DefaultCallback<Void>( this )
    {
      ...
      public void handleResponse( Void response )
      {
        ...
        startActivity( new Intent( com.examples.eventjockey.login.RestorePasswordActivity.this, com.examples.eventjockey.login.PasswordRecoveryRequestedActivity.class ) );
        finish();
      }
    } );
  }
